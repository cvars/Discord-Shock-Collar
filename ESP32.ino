...
int strength_now = 0;
int duration_now = 0;
int command_now = 0; // Declare command_now globally
...
void loop() {
    ...
    if (duration_now > 0) {
        ...
        } else if (command_now == 2) {
            tx_packet(CHANNEL::CHANNEL_1, TYPE::BUZZ, strength_now, 0x20, 0x89);
        }
        Serial.print(".");
